...
const Cross = createLucideIcon("cross", __iconNode$k);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Music2 = createLucideIcon("music-2", __iconNode$b);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const MISSION_POINTS = [
  {
    ...
    description: "Creating an environment of love, acceptance, and support where everyone belongs."
  },
  {
    Icon: Zap,
    title: "Bold Witnesses",
    description: "Empowering believers to be bold witnesses for Christ in every sphere of life."
  },
  {
    Icon: Share2,
    title: "Gospel Outreach",
    description: "Sharing the Gospel across communities, schools, workplaces, and homes."
  },
  {
    Icon: Sparkles,
    title: "Discover Your Gifts",
    description: "Equipping believers to discover and develop their God-given gifts."
  },
  {
    Icon: Music2,
    title: "Worship Excellence",
    description: "Establishing a strong, Spirit-filled worship team that glorifies God."
  },
  {
    Icon: GraduationCap,
    title: "Leadership Development",
    description: "Training future leaders through Bible-based education and mentorship."
  }
];
const SERMONS = [
  {
...
const BULLETIN = [
  {
    ...
    message: "The Youth of New Life Evangelistic Church will embark on a challenge to read through the Bible in a year. The plan is to read two chapters a day. Join us on this journey!",
    expiryDate: /* @__PURE__ */ new Date("2026-12-31")
  },
  {
    icon: "🙏",
    event: "Week of Prayer and Fasting",
    date: "Starting March 30th",
    message: "The church will begin a week of prayer and fasting. Let's come together in unity and seek God's guidance.",
    expiryDate: /* @__PURE__ */ new Date("2026-03-30")
  },
  {
    icon: "✝️",
    event: "Good Friday Service",
    date: "Friday, April 3rd at 3:30 PM",
    message: "Join us for our Good Friday service as we reflect on the sacrifice of Jesus Christ.",
    expiryDate: /* @__PURE__ */ new Date("2026-04-03")
  },
  {
    icon: "🌟",
    event: "Witnessing Opportunity",
    date: "This Saturday at 11 AM",
    message: "There will be a witnessing opportunity this Saturday. We will meet here at 11 AM to spread the word of God.\n\nTheme: The Power, The Mystery's, & The Virtue of the Cross",
    scriptures: [
    ...
    expiryDate: /* @__PURE__ */ new Date("2026-04-05")
  },
  {
    icon: "🌅",
    event: "Easter Sunday",
    date: "5th April 2026",
    message: "Join us for a special Resurrection Sunday celebration! Come and commemorate the risen Christ with the whole family.",
    expiryDate: /* @__PURE__ */ new Date("2026-04-05")
  },
  {
    icon: "👨‍👧‍👦",
    event: "Father's Day",
    date: "21st June 2026",
    message: "Honoring all fathers and father figures in our congregation. A special service to celebrate the gift of fatherhood.",
    expiryDate: /* @__PURE__ */ new Date("2026-06-21")
  }
];
const SCHEDULE = [
...
const MINISTRIES = [
  {
    Icon: Users,
    name: "Youth Ministry",
    description: "Empowering teens to walk boldly in faith and discover their God-given purpose."
  },
  {
    Icon: Heart,
    name: "Women's Ministry",
    description: "A sisterhood of faith, prayer, and community for women at every stage of life."
  },
  {
    Icon: BookOpen,
    name: "Men's Ministry",
    description: "Building men of integrity, leadership, and spiritual discipline through fellowship."
  },
  {
    Icon: Baby,
    name: "Children's Ministry",
    description: "Planting seeds of faith in the youngest hearts with fun, interactive Bible learning."
  },
  {
    Icon: Globe,
    name: "Outreach Ministry",
    description: "Extending God's love beyond our walls through local and global mission work."
  },
  {
    Icon: Music2,
    name: "Worship Ministry",
    description: "Leading the congregation in Spirit-filled worship through music, song, and praise to glorify God."
  }
];
...
const WORSHIP_TIMES = [
  {
    ...
    address: "The Chapel On The Hill, Church Rise / South Road, Forest Hill, London, SE23 2UJ",
    note: ""
  },
  {
...
function SectionHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col items-center gap-4 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: `text-xs font-bold tracking-[0.35em] select-none ${light ? "text-gold/60" : "text-gold/70"}`,
        "aria-hidden": "true",
        children: "✦  ✦  ✦"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        className: `font-display text-3xl sm:text-4xl font-bold leading-tight text-center ${light ? "text-white" : "text-navy"}`,
        children
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-px w-10 ${light ? "bg-white/25" : "bg-gold/35"}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
...
function getNextFridayTarget() {
  ...
  if (daysUntil === 0) {
    const hours = now2.getUTCHours();
    const minutes = now2.getUTCMinutes();
...
function isBroadcastingNow() {
  const now2 = /* @__PURE__ */ new Date();
  return now2.getUTCDay() === 5 && now2.getUTCHours() === 16;
}
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-bold text-sm uppercase tracking-widest", children: "Past Events & Programs" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 rounded-full bg-gold/20 text-gold text-xs font-bold px-2.5 py-0.5", children: pastBulletin.length })
              ] }),
              open ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "h-5 w-5 text-gold/70 group-hover:text-gold transition-colors" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-5 w-5 text-gold/70 group-hover:text-gold transition-colors" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleContent, { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: pastBulletin.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opacity-75", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BulletinCard, { item }) }, item.event)) }) })
      ]
    }
  );
}
function App() {
  ...
  const [contactMessage, setContactMessage] = reactExports.useState("");
...
${contactMessage}`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `fixed inset-x-0 top-0 z-50 transition-shadow duration-300 ${scrolled ? "shadow-card" : ""} bg-navy`,
        children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-base font-bold tracking-wide text-white hidden xl:block", children: "NLEM Worship Centre" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "lg:hidden bg-navy border-t border-white/20 px-6 py-4 flex flex-col gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "radial-gradient(ellipse 90% 70% at 50% 38%, oklch(0.19 0.06 233 / 0.85), transparent 70%)"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-gold/50 to-transparent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute bottom-1 inset-x-0 h-px bg-gradient-to-r from-transparent via-gold/20 to-transparent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-4xl px-6 pb-12 pt-28 text-center animate-fade-in-up", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-5 text-[11px] font-bold tracking-[0.45em] uppercase text-gold/75 animate-fade-in", children: "✦  Welcome to  ✦" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mb-7 flex items-center justify-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-14 bg-gradient-to-r from-transparent to-gold/55" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-1.5 rounded-full bg-gold/70" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-28 bg-gold/55" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-1.5 rounded-full bg-gold/70" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-14 bg-gradient-to-l from-transparent to-gold/55" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl font-bold leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-6xl xl:text-[4.5rem]", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: "Worship Centre"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-9 mb-5 flex items-center justify-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 max-w-[72px] bg-gold/35" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Cross, { className: "h-3.5 w-3.5 text-gold/60" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 max-w-[72px] bg-gold/35" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm sm:text-base font-bold uppercase tracking-[0.22em] text-gold", children: "Taking the whole WORD of GOD to the whole WORLD!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-5 mx-auto max-w-xl text-sm sm:text-[15px] text-white/60 italic font-light leading-relaxed", children: [
                "2 Kings 7:9 “This is a day of good news and we are keeping it to ourselves…Let’s go back and tell the people”",
                " ",
                "(NLT)"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 mx-auto max-w-xl rounded-xl border border-gold/60 bg-gold/10 px-6 py-4 text-center backdrop-blur-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-gold mb-1", children: "2026 Theme" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold uppercase tracking-wider text-gold leading-snug", children: "Your Year of Abundance" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gold/90 mt-1", children: "Moving from Lack to Abundance" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-yellow-300 font-bold mt-1.5 tracking-wide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          "aria-label": "About Us",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-12 lg:grid-cols-2 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { className: "items-start", children: "About Us" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-5 text-foreground/80 leading-relaxed", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-navy mb-2 uppercase tracking-wider text-sm", children: "Our Mission" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "To love God with all our heart, soul, and mind — and to love our neighbors as ourselves. We are committed to making disciples who make disciples, transforming our community through the power of the Gospel." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-navy mb-2 uppercase tracking-wider text-sm", children: "Our Vision" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We envision a congregation where every person finds belonging, purpose, and spiritual growth. A community that reflects the diversity of God’s kingdom and extends His grace to the world around us." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-navy mb-2 uppercase tracking-wider text-sm", children: "Our History" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Founded in 1997, New Life Evangelistic Ministries Worship Centre has grown into a vibrant congregation committed to spreading the Word of God to all nations. Through decades of faithful ministry, we have baptised many, trained many leaders, and served thousands in our community." })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-6 -left-6 bg-navy rounded-2xl p-5 shadow-card", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-gold", children: "Est." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/80 mt-1", children: "1997" })
              ] })
            ] })
          ] }) })
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Founder’s Message" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-center justify-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-gold/30" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Cross, { className: "h-5 w-5 text-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-gold/30" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-10 rounded-2xl bg-white px-8 py-10 shadow-card sm:px-14 sm:py-14", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-foreground/80 leading-relaxed text-base sm:text-lg", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                  "A warm and special greeting to you! As the head pastor of New Life Evangelistic Ministries International Worship Centre, I am overjoyed and deeply thankful to lead such an incredible body of Christ. New Life was established in 1997. Our core mission is to spread the",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-navy font-bold", children: "WHOLE WORD OF GOD TO THE WHOLE WORLD" }),
                  ", sharing the good news of His profound love and purpose for each of our lives. In doing so, we aim to deepen our faith together, live with unwavering integrity, and actively serve our communities."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Evangelism is central to our mission, driving us to spread hope and love throughout the world. It is all about living in a way that honours God, and inviting others to discover His grace. The Bible is our guiding light, encouraging us to trust in His divine plans, even when facing adversity, and to commit to His teachings every day." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Our congregation is a family, deeply rooted in love, committed to God, and with a strong desire to grow together in faith and service. All are welcome to fellowship with us, come as you are and expect to leave with a renewed sense of hope and understanding of Christ." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-col items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-24 bg-gold/40" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl font-bold tracking-widest text-navy uppercase", children: "Rev Patrick Adu Amankwah" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-sm font-semibold uppercase tracking-[0.25em] text-gold",
                  style: { fontVariant: "small-caps" },
                  children: "General Overseer"
                }
              )
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { light: true, children: "Our Mission" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-1 gap-6 md:grid-cols-2", children: MISSION_POINTS.map(({ Icon: Icon2, title, description }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 flex h-12 w-12 items-center justify-center rounded-full border-2 border-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5 text-gold" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-white text-lg", children: title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-white/70 leading-relaxed", children: description })
                  ] })
                ]
              },
              title
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Worship Times" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2", children: WORSHIP_TIMES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex h-14 w-14 items-center justify-center rounded-full border-2 border-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-6 w-6 text-gold" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-navy text-lg", children: s.service }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-3xl font-display font-bold text-gold", children: s.time }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 h-px w-10 bg-gold/40" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm font-medium text-foreground/70", children: s.location }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: s.service === "Wednesday Midweek Service" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold uppercase tracking-widest text-navy", children: "How to Get There?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-2 h-0.5 w-12 rounded-full bg-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    "data-ocid": "worship.link",
                    children: "Sunday Service: View Directions Here"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    className: "text-sm font-bold uppercase tracking-wider text-gold underline underline-offset-4 hover:text-gold/80 transition-colors",
                    "data-ocid": "worship.link",
                    children: "Wednesday Service: View Directions Here"
                  }
                )
              ] })
            ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          "aria-label": "Sermons",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Latest Sermons" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4", children: SERMONS.map((sermon, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-video overflow-hidden bg-navy", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: sermon.img,
                      alt: sermon.title,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-navy text-lg leading-snug", children: sermon.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: sermon.speaker }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 text-xs text-muted-foreground", children: sermon.date }),
                    sermon.summary && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 space-y-2 overflow-hidden line-clamp-6", children: sermon.summary.split("\n\n").map((para) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "text-xs text-muted-foreground leading-relaxed",
                        children: para.split(/(\([^)]+\))/).map(
                          (part) => /^\([^)]+\)$/.test(part) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "em",
                            {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex gap-3", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { className: "h-3 w-3" }),
                            " Listen"
                          ]
                        }
                      )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          "aria-label": "Events",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Upcoming Events & Activities" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-center text-foreground/60 text-sm max-w-xl mx-auto", children: "Stay connected with all our services, special events, and ministry activities throughout the year." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 max-w-3xl mx-auto rounded-2xl overflow-hidden shadow-card", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 bg-navy px-6 py-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-gold", children: "Activity / Program" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-gold", children: "Timing" })
              ] }),
              SCHEDULE.map(({ activity, timing }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `grid grid-cols-2 px-6 py-5 border-b border-gray-100 last:border-b-0 ${i % 2 === 0 ? "bg-white border-l-4 border-l-transparent" : "bg-gray-50 border-l-4 border-l-gold/40"}`,
                  "data-ocid": `events.item.${i + 1}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-navy text-sm leading-snug pr-4", children: activity }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 shrink-0 text-gold" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70", children: timing })
                    ] })
                  ]
                },
                activity
        ...
        "section",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-4xl px-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "TV Ministry" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Tv, { className: "h-5 w-5 text-navy" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-black uppercase tracking-[0.2em] text-navy", children: "New Life TV Programme" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 bg-red-600 rounded-full px-3 py-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2 w-2 rounded-full bg-white animate-pulse" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black tracking-widest text-white uppercase", children: "On Air" })
                          ] })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", style: { background: "#ffffff" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs font-black uppercase tracking-[0.35em] text-navy/50 mb-6", children: isBroadcasting ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Every Friday · Weekly Broadcast" }) }),
                      isBroadcasting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          className: "mb-8 rounded-2xl p-8 flex flex-col items-center gap-4",
                          style: {
                            background: "linear-gradient(135deg, #060e1c 0%, #0d1f3c 100%)",
                            border: "1px solid rgba(212,175,55,0.4)",
                            boxShadow: "0 4px 24px rgba(6,14,28,0.18)"
                          },
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded-full bg-red-500 animate-pulse" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "a",
                              {
                                ...
                                children: "Watch Live on Faithworld TV →"
                              }
                            )
                          ]
                        }
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3", children: [
                              ...
                              "div",
                              {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-black uppercase tracking-[0.25em] text-white/40", children: label })
                                ]
                              },
                              label
                            )) })
                      ...
                      ].map(({ flag, region, time }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-[0.2em] text-navy/60", children: region }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-navy font-bold text-sm tabular-nums", children: time })
                          ]
                        },
                        region
                      )) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap items-center justify-center gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-navy/50 font-semibold", children: "Watch on" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "a",
                          {
                            href: "https://www.faithworldtv.com",
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Tv, { className: "h-3 w-3" }),
                              "Faithworld TV"
                            ]
                          }
                        ),
                        ...
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-navy/20" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-black uppercase tracking-[0.25em] text-navy", children: "Prayer Request" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-navy/20" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-navy/70 text-sm leading-relaxed", children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "a",
                                {
                                  ...
                                  style: { color: "#b8962e" },
                                  children: "07920035100"
                                }
                              ),
                              ".",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                              "We have intercessors who will be happy to stand in the gap with you."
                            ] })
                          ]
                        }
                      )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Our Ministries" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3", children: MINISTRIES.map(({ Icon: Icon2, name, description }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-6 w-6 text-navy" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-navy text-lg", children: name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-foreground/70 leading-relaxed", children: description })
                ]
              },
              name
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold uppercase tracking-widest text-navy", children: "Ministries Meet Up Times" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 w-12 rounded-full bg-gold" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto rounded-2xl overflow-hidden shadow-card", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 bg-navy px-6 py-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-gold", children: "Ministries" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-gold", children: "Meet Up Times" })
                ] }),
                MINISTRIES_MEETUP.map(({ ministry, times }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `grid grid-cols-2 px-6 py-4 border-b border-gray-100 last:border-b-0 ${i % 2 === 0 ? "bg-white" : "bg-gray-50"}`,
                    "data-ocid": `ministries.item.${i + 1}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-navy text-sm", children: ministry }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70", children: times })
                    ]
                  },
                  ministry
                ))
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  children: "Link to Join All Online Meetings"
                }
              ) })
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          "aria-label": "Prayers",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Prayer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 max-w-3xl mx-auto rounded-2xl bg-white p-8 shadow-card text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/80 leading-relaxed", children: "Prayer is our direct line of communication with God. It’s a way for us to express our gratitude, seek guidance, and find comfort in times of need. Through prayer, we can build a stronger relationship with God and experience His presence in our lives. Praying and standing together are important aspects of the church. The church has designated prayer times for communal worship and intercession." }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 grid grid-cols-1 gap-6 lg:grid-cols-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-white p-8 shadow-card", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold uppercase tracking-widest text-navy mb-4", children: "Join Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 w-10 rounded-full bg-gold mb-6" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-sm text-foreground/80 leading-relaxed", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                    "Simply download the FREE CONFERENCE APP and use",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-navy", children: "Meeting ID: REVDPATRICK3" })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Join online for video and screen sharing:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href: "https://join.freeconferencecall.com/revdpatrick3",
                      ...
                      children: "https://join.freeconferencecall.com/revdpatrick3"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "pt-2 font-semibold text-navy", children: "Additional options to connect:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-navy", children: "Dial-in Number (GB):" }),
                    " ",
                    "0330 777 2413"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-navy", children: "Access Code:" }),
                    " ",
                    "197361#"
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-navy p-8 shadow-card", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold uppercase tracking-widest text-gold mb-4", children: "Weekly Prayer Activities" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 w-10 rounded-full bg-gold mb-6" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm text-white/85", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold uppercase tracking-wider text-gold", children: "Prayers Happen Every Day (except Sunday):" }),
                  [
                    "06.00–06.30",
                    "12.00–12.30",
                    "17.00–17.30",
                    "20.00–20.30",
                    "00.00–00.30"
                  ].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "pl-3 border-l-2 border-gold/40", children: t }, t)),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "pt-3 font-bold uppercase tracking-wider text-gold", children: "Sundays" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "pl-3 border-l-2 border-gold/40", children: [
                    "06.00\\u201306.30",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/50 text-xs", children: "(Prayer Time)" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "pl-3 border-l-2 border-gold/40", children: [
                    "10.30\\u201313.30",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/50 text-xs", children: "(Church Service)" })
                  ] })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 rounded-2xl bg-navy px-8 py-6 text-center shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold uppercase tracking-widest text-gold sm:text-base", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { light: true, children: "Meet Our Leadership Team" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-4", children: LEADERSHIP.map((leader, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-white text-base", children: leader.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs font-semibold uppercase tracking-wider text-gold", children: leader.title })
                ]
              },
              leader.name
            )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          "aria-label": "Gallery",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Ministry Life Gallery" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3", children: GALLERY.map(({ src, alt, objectPosition }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
      ...
      lightboxIndex !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-black/50 px-4 py-1 text-sm text-white/80", children: [
              lightboxIndex + 1,
              " / ",
              GALLERY.length
            ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Giving" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-2 mt-12", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl bg-white border border-gold/30 border-t-4 border-t-gold overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full bg-gold" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold uppercase tracking-widest text-gold mb-4", children: "Tithes and Offerings" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 text-sm leading-relaxed mb-8", children: "Your generous tithes and offerings are vital for the financial support of the church. Your faithful giving helps cover the ministry's operating expenses and demonstrates your commitment and faith. You can make payments for tithes, offerings, or any other donations to the Church Account using the following methods." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-navy/5 border border-gold/30 p-6 space-y-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-xs font-bold uppercase tracking-widest text-gold border-b border-gold/30 pb-3 mb-5", children: [
                      "Church Account Details",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-gray-500 font-normal normal-case tracking-normal text-xs mt-0.5", children: "For Tithes and Offerings Only" })
                    ] }),
                    [
                      {
                        label: "Account Name",
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wider text-gold/80", children: label }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-navy sm:text-right", children: value })
                        ]
                      },
                      label
                    ))
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl bg-white border border-gold/30 overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full bg-gold" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold uppercase tracking-widest text-gold mb-4", children: "Welfare" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 text-sm leading-relaxed mb-8", children: "The church has a welfare scheme to assist and support individuals in times of emergencies or other unforeseen circumstances. If you are interested, you will become an automatic member and will be required to pay a £60 membership fee, as well as monthly dues of £10." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-navy/5 border border-gold/30 p-6 space-y-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-xs font-bold uppercase tracking-widest text-gold border-b border-gold/30 pb-3 mb-5", children: [
                      "Welfare Dues Account Details",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-gray-500 font-normal normal-case tracking-normal text-xs mt-0.5", children: "For Welfare Only" })
                    ] }),
                    [
                      {
                        label: "Account Name",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "“Thank You for Your Generous Giving”"
              }
            )
          ] })
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { light: true, children: "Church Bulletin" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-white/60 mb-10 mt-4 max-w-2xl mx-auto", children: "Upcoming news, information and programme updates for our congregation." }),
            (() => {
              ...
              const BulletinCard = ({
                item
              }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-gold/40 bg-white/10 p-6 hover:bg-white/15 transition-all duration-300", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full bg-gold/20 p-3 inline-flex items-center justify-center text-2xl w-16 h-16 mb-3", children: item.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest mb-1 text-gold", children: item.date }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg text-white mb-2", children: item.event }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/70 text-sm leading-relaxed space-y-1", children: item.message.split("\n").map((line) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: line }, line)) }),
                item.scriptures && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-gold/20", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-gold uppercase tracking-widest mb-2", children: "Relevant Scriptures:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: item.scriptures.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "li",
                    {
                      className: "text-white/60 text-xs flex items-start gap-1",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold mt-0.5", children: "•" }),
                        s
                      ]
                    },
                    s
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                upcomingBulletin.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto", children: upcomingBulletin.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(BulletinCard, { item }, item.event)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-white/50 italic mt-4", children: "No upcoming announcements at this time." }),
                pastBulletin.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          "aria-label": "Contact",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Contact Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 grid grid-cols-1 gap-10 lg:grid-cols-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-navy/5 flex flex-col items-center justify-center h-64 lg:h-full min-h-[300px] text-navy/50 gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-10 w-10 text-gold group-hover:scale-110 transition-transform" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-navy/80", children: "New Life Evangelistic Ministries Worship Centre" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-navy/50 text-center px-4", children: "Christ Church Chapel, The Chapel On The Hill, Church Rise/ South Road, Forest Hill, London SE23 2UJ" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 rounded-xl bg-gold text-navy font-bold px-6 py-3 text-xs uppercase tracking-widest group-hover:bg-gold/90 transition-colors shadow-md", children: "View on Google Maps →" })
                  ] })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3 border-t border-border pt-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 text-gold mt-0.5 shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold", children: "Address" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "a",
                        {
                          href: "https://www.google.com/maps?q=Christ+Church+Chapel+Church+Rise+Forest+Hill+London+SE23+2UJ",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold", children: "Phone" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold", children: "Email" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/70 mt-0.5 break-all", children: "Nlem.worshipcentre@gmail.com" })
                    ] })
                  ] })
                ] })
              ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 bg-gradient-to-r from-transparent via-gold/60 to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-navy border-t border-white/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-10 sm:grid-cols-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold uppercase tracking-widest text-gold mb-4", children: "Quick Links" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold uppercase tracking-widest text-gold mb-4", children: "Follow Us" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-white/60", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sun: 10:30 AM | Wed: 7:00 PM" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-white/60", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 text-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "07888608000 | 07733399248" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-white/60", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Nlem.worshipcentre@gmail.com" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold uppercase tracking-widest text-gold mb-4", children: "Connect With Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-navy text-lg leading-tight", children: "New Life Evangelistic Ministries Worship Centre" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/60 leading-relaxed", children: "A place to belong, grow, and serve. Join us as we build a community rooted in faith, love, and the grace of God." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              onClick: () => handleNavClick("#contact"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 px-6 py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl flex flex-col items-center justify-between gap-2 sm:flex-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-navy/40", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " New Life Evangelistic Ministries Worship Centre. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-navy/40", children: [
          "Built with ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "inline h-3 w-3 text-gold" }),
          " using",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
