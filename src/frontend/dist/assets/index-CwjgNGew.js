...
function useNextFridayCountdown() {
  const [timeLeft, setTimeLeft] = reactExports.useState(getNextFridayTimeLeft);
  reactExports.useEffect(() => {
    const id = setInterval(() => setTimeLeft(getNextFridayTimeLeft()), 1e3);
