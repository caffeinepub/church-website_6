...
function SectionHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col items-center gap-3 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        className: `font-display text-2xl font-bold uppercase tracking-widest ${light ? "text-white" : "text-navy"}`,
        children
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 w-16 rounded-full bg-gold" })
  ] });
}
function App() {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          "aria-label": "Hero",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-7xl px-6 pt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl animate-fade-in-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl font-bold leading-tight text-white drop-shadow-lg sm:text-6xl lg:text-7xl", children: [
              "Welcome to",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "New Life Evangelistic Ministries Worship Centre" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-lg text-white/85 sm:text-xl", children: "A place to belong, grow, and serve. Join our family as we journey together in faith, hope, and love." }),
