...
function useNextFridayCountdown() {
  const getTimeLeft = () => {
    ...
    const londonNow = new Date(
      now2.toLocaleString("en-GB", { timeZone: "Europe/London" })
    );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-4xl px-6 pb-12 pt-28 text-center animate-fade-in-up", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 mx-auto max-w-xl rounded-xl border border-amber-400/60 bg-amber-400/10 px-6 py-4 text-center backdrop-blur-sm", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-400 font-bold mt-1.5 tracking-wide", children: "1 Kings 18:41–45" })
              ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "sermons", className: "py-0", "aria-label": "Sermons", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-6 sm:grid-cols-3", children: SERMONS.map((sermon, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
